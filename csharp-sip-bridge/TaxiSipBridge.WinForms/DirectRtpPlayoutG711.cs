...
public class DirectRtpPlayoutG711 : IDisposable
{
    ...
    private const int MIN_FRAMES_TO_START = 15; // 300ms cushion to prevent start cutoff
    private const int GRACE_PERIOD_FRAMES = 8;  // 160ms grace to prevent end cutoff
